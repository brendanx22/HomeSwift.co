...
export default function SignupPage() {
  ...
  return (
    <div 
      className="min-h-screen flex justify-center items-start pt-32 sm:pt-40 md:pt-48 pb-24 sm:pb-32 md:pb-40 px-6 bg-cover bg-center bg-no-repeat relative w-full"
